    ...
    <div class="bg-neutral-200/30 rounded-lg p-5 flex flex-col gap-3">
        ...
        <form method="POST" action="/todos/{{ $todo->id }}">
            ...
            <div class="flex justify-center gap-5">
                ...
                <button type=submit form="delete-todo" class="bg-neutral-200/50 hover:bg-neutral-200/80 border border-neutral-400 px-2 py-1 rounded cursor-pointer w-fit">delete with isDeleted</button>
            </div>
        </form>
